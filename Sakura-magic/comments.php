				...
				if(comments_open()){
					...
					$args = array(
						...
						'fields' => apply_filters( 'comment_form_default_fields', array(
                            'avatar' => '<div class="cmt-info-container"><div class="comment-user-avatar"><img src="/wp-content/themes/Sakura/images/custom/qq.png" onerror="javascript:this.src=\'/wp-content/themes/Sakura/images/custom/qq.png\';"><div class="socila-check qq-check"><i class="fa fa-qq" aria-hidden="true"></i></div><div class="socila-check gravatar-check"><i class="fa fa-google" aria-hidden="true"></i></div></div>',
							'author' =>
