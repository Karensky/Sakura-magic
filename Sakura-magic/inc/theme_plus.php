...
function the_headPattern(){
  ...
  <div class="pattern-center <?php if(is_single()){echo $center;} ?>">
    <div class="j-article-img pattern-attachment-img lazyload" style="background-image: url(https://cdn.jsdelivr.net/gh/fz6m/Private-web@2.0.0/php/image/orange.progress-bar-stripe-loader.svg)" data-src="<?php echo $full_image_url; ?>"> </div>
    <!--<div class="pattern-attachment-img parallax-container" > -->
    <!--<div class='parallax'>-->
    <!--<img class="lazyload" src="<?php echo $full_image_url; ?>"/>-->
    <!--</div>-->
    <!--</div>-->
...
function the_video_headPattern_hls(){
  ...
  if(is_single()){
    ...
    $full_image_url = z_taxonomy_image_url();
    $thubm_image_url = 'https://cdn.jsdelivr.net/gh/fz6m/Private-web@2.0.0/php/image/orange.progress-bar-stripe-loader.svg';
    $des = category_description() ? category_description() : ''; // 描述
    $t .= '<h1 class="cat-title">'.single_cat_title('', false).'</h1>';
    $t .= ' <span class="cat-des">'.$des.'</span>';
  }elseif(is_search()){
...
function header_user_menu(){
  ...
  if(is_user_logged_in()){
    ...
    <div class="header-user-avatar">
      <img class="faa-spin animated-hover" src="<?php echo get_avatar_profile_url();/*$ava;*/ ?>" width="30" height="30">
      <div class="header-user-menu">
        <div class="herder-user-name">用户
        ...
        <div class="user-menu-option">
          <?php if (current_user_can('level_10')) { ?>
            ...
            <a href="<?php bloginfo('url'); ?>/wp-admin/post-new.php" target="_blank">写文章</a>
            <a href="<?php bloginfo('url'); ?>/wp-admin/post-new.php?post_type=shuoshuo" target="_blank">发说说</a>
          <?php } ?>
  ...
  <?php
    ...
    $ava = 'https://cdn.jsdelivr.net/gh/fz6m/Private-web@2.0.0/php/image/none.png';
  ...
  <div class="header-user-avatar">
    ...
    <div class="header-user-menu">
      <div class="herder-user-name no-logged"><a href="<?php echo $login_url; ?>" target="_blank" style="color:#333;font-weight:bold;text-decoration:none">Link Start</a>
      </div>
    </div>
  </div>
  <?php 
...
function siren_get_useragent($ua){
  if(akina_option('open_useragent')){
    ...
    $imgurl = 'https://cdn.jsdelivr.net/gh/fz6m/Private-web@2.0.0/php/image/ua/svg/';
