...
mashiro_option.entry_content_theme_src = "https://cdn.jsdelivr.net/gh/fz6m/Private-web@2.0.0/css/main/sakura.min.css?<?php echo akina_option('cookie_version', ''); ?>";
<?php }elseif(akina_option('entry_content_theme') == "github") {?>
mashiro_option.entry_content_theme_src = "<?php echo get_template_directory_uri() ?>/cdn/theme/github.css?<?php echo akina_option('cookie_version', ''); ?>";
<?php } ?>
mashiro_option.entry_content_theme = "<?php echo akina_option('entry_content_theme'); ?>";

<?php if(akina_option('jsdelivr_cdn_test')){ ?>
mashiro_option.jsdelivr_css_src = "https://cdn.jsdelivr.net/gh/fz6m/Private-web@2.0.0/css/main/lib.min.css?<?php echo akina_option('cookie_version', ''); ?>";
<?php } else { ?>
