...
<!--custom css-->
<?php
echo "<link rel=\"stylesheet\" type=\"text/css\" href=\"https://cdn.jsdelivr.net/gh/fz6m/Private-web@2.0.4/css/custom/all.min.css\" />";
echo "<link rel=\"stylesheet\" type=\"text/css\" href=\"https://cdn.jsdelivr.net/gh/fz6m/Private-web@2.0.0/css/custom/ipad.min.css\" />";
?>
...
if (  ( is_home() || is_front_page() ) ) echo " 🌸 ";if ( $paged >= 2 || $page >= 2 ) echo ' 🌸 ' . sprintf( __( 'page %s ','sakura'), max( $paged, $page ) );/*第 %s 页*/?>
</title>
<?php
