...
<?php if ( !akina_option('focus_infos') ){ ?>
	<div class="focusinfo">
		...
		<div class="header-info">
            <p id="source" style="display:none;"><?php echo akina_option('admin_des', 'Hi, Mashiro?'); ?></p>
            <div id="output-wrap" class="output-imgbox">
				<span id="output"></span>
			</div>
            ...
            <div class="top-social_v2">
                ...
                <li><a href="<?php echo akina_option('telegram', ''); ?>" target="_blank" class="social-lofter" title="telegram"><img src="https://cdn.jsdelivr.net/gh/fz6m/Private-web@2.0.0/image/index/social-contact/telegram.svg"/></a></li>
                <?php } ?>	
                <?php if (akina_option('csdn')){ ?>
                <li><a href="<?php echo akina_option('csdn', ''); ?>" target="_blank" class="social-wangyiyun" title="CSDN"><img src="https://cdn.jsdelivr.net/gh/fz6m/Private-web@2.0.0/image/index/social-contact/csdn.png"/></a></li>
                <?php } ?>
                ...
                <li><a href="<?php echo akina_option('wangyiyun', ''); ?>" target="_blank" class="social-wangyiyun" title="CloudMusic"><img src="https://cdn.jsdelivr.net/gh/fz6m/Private-web@2.0.0/image/index/social-contact/netease.png"/></a></li>
                <?php } ?>
                ...
                <li><a href="<?php echo akina_option('github', ''); ?>" target="_blank" class="social-github" title="github"><img src="https://cdn.jsdelivr.net/gh/fz6m/Private-web@2.0.0/image/index/social-contact/github.png"/></a></li>
                <?php } ?>	
...
<span><i class="fa fa-chevron-down" aria-hidden="true"></i></span></div>
