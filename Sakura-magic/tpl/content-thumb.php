...
?>
	<article class="post post-list-thumb <?php echo $class; ?>" itemscope="" itemtype="http://schema.org/BlogPosting">
		<div class="post-thumb">
			<a href="<?php the_permalink(); ?>"><img class="lazyload" src="https://cdn.jsdelivr.net/gh/fz6m/Private-web@2.0.0/php/image/orange.progress-bar-stripe-loader.svg" data-src="<?php echo $post_img; ?>"></a>
		</div><!-- thumbnail-->
		<div class="post-content-wrap">
			<div class="post-content">
				...
				<a href="<?php the_permalink(); ?>" class="post-title post-title-plus"><h3><?php the_title();?></h3></a>
				<div class="post-meta">
