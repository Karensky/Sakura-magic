	...
	<div class="post-entry">
	  <div class="feature">
		<?php if ( has_post_thumbnail() ) { ?>
			...
			<?php } else {?>
			<a href="<?php the_permalink();?>"><div class="overlay"><i class="iconfont icon-text"></i></div><img src="https://cdn.jsdelivr.net/gh/fz6m/Private-web@2.0.0/image/article/circular.jpg" /></a>
			<?php } ?>
		</div>	
